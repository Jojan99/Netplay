...
Route::prefix('management')->middleware('empresa.propia')->group(function () {
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::post('pppoe/validar',    [ManagementRouterController::class, 'pppoeValidar']);
    ...
    Route::prefix('gestion-remota')->middleware('role:admin')->group(function () {
        ...
        Route::get('/aprovisionamiento/cliente/{userId}', [\App\Http\Controllers\GestionRemotaController::class, 'aprovisionamientoDeCliente'])->whereNumber('userId');
